globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file://C:/Users/reyes/nuxt3-app/node_modules/node-fetch-native/dist/polyfill.mjs';
...
import { createRenderer } from 'file://C:/Users/reyes/nuxt3-app/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://C:/Users/reyes/nuxt3-app/node_modules/devalue/index.js';
import { renderToString } from 'file://C:/Users/reyes/nuxt3-app/node_modules/vue/server-renderer/index.mjs';
...
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file://C:/Users/reyes/nuxt3-app/node_modules/ufo/dist/index.mjs';
...
const _9tRTxvYIlj = (function(nitro) {
...
const _lazy_PwadVC = () => Promise.resolve().then(function () { return _____$1; });
const _lazy_pRFCEM = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/**', handler: _lazy_PwadVC, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_pRFCEM, lazy: true, middleware: false, method: undefined },
...
const getClientManifest = () => import('file://C:/Users/reyes/nuxt3-app/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('file://C:/Users/reyes/nuxt3-app/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
